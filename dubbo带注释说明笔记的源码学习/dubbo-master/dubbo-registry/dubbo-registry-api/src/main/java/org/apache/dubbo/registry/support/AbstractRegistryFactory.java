...
public abstract class AbstractRegistryFactory implements RegistryFactory {
    ...
    public Registry getRegistry(URL url) {
         ...
         * &backup=192.168.1.230:2181,192.168.1.231:2181
         * &dubbo=2.0.2
         * &interface=org.apache.dubbo.registry.RegistryService
         * &pid=35300
         * &timeout=10000
         * &timestamp=1644567329611
         */
        url = URLBuilder.from(url)
                ...
                .build();
        //url转成string字符串：zookeeper://192.168.1.73:2181/org.apache.dubbo.registry.RegistryService
        String key = createRegistryCacheKey(url);
        // Lock the registry access process to ensure a single instance of the registry
        //锁定注册中心获取过程，保证注册中心单一实例
        LOCK.lock();
        try {//如果缓存已有，说明，已经建立过连接器
    ...
    /**
     * 通过子类实现，例如，使用zookeeper做注册中心，那么就会在ZookeeperRegistryFactory实现
     * @param url
     * @return
     */
